namespace OtherBase
{
    ...
    "Token=null";
            ...
            this.titleTextBox.Value = "Розыск по району Нижегородский";
            // 
            // reportFooter
            // 
    ...
    "h+\'.\'+ Fields.Дата_прибытия_в_военкомат.Year";
            ...
            this.Filters.Add(new Telerik.Reporting.Filter("=Fields.Район", Telerik.Reporting.FilterOperator.Equal, "2"));
